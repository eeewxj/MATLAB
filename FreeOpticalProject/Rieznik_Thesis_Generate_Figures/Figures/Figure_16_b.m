...
format long e
fprintf(1,'\n----------------------------------------------');
fprintf(1,'\nSimulating Figure 16b of Rieznik´s thesis'); 
...
createFig6b(vw,10*log10(selectedgains),10*log10(selectedgains2));
