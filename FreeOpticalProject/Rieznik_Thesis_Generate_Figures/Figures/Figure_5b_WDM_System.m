...
% load analitical_8_channels_50km;
% globalerror = sqrt(sum(abs(analitical_8_channels_50km-u).^2) / sum(abs(analitical_8_channels_50km).^2))
load analitical_8_channels_50km;
globalerror = sqrt(sum(abs(analitical_8_channels_50km-u).^2) / sum(abs(analitical_8_channels_50km).^2))
